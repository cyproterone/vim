...
local lsp_recommends = function ()
  ...
  bindings.map.normal("gs", "<cmd>lua vim.lsp.buf.definition()<CR>")
  bindings.map.normal("gS", "<cmd>lua vim.lsp.buf.references()<CR>")

  bindings.map.normal("K", "<cmd>lua vim.lsp.buf.hover()<CR>")

  bindings.map.normal("<Leader>cd", "<cmd>lua vim.lsp.buf.signature_help()<CR>")
  bindings.map.normal("<Leader>cD", "<cmd>lua vim.lsp.buf.type_definition()<CR>")
